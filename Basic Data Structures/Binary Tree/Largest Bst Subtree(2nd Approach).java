...
public class Main {
  ...
  public static BSTpair largestBST(Node node){
    ...
    if(curr.isBST){
      curr.lbstroot = node;
      curr.lbstsize = lans.lbstsize + rans.lbstsize + 1;
    }else if(lans.lbstsize > rans.lbstsize){
      curr.lbstroot = lans.lbstroot;
      curr.lbstsize = lans.lbstsize;
    }else{
      curr.lbstroot = rans.lbstroot;
      curr.lbstsize = rans.lbstsize;
    }
  ...
  public static void main(String[] args) throws Exception {
    ...
    System.out.println(ans.lbstroot.data + "@" + ans.lbstsize);
  }
