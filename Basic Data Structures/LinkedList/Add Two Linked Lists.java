...
public class Main {
  ...
  public static class LinkedList {
    ...
    public static LinkedList addTwoLists(LinkedList one, LinkedList two) {
      ...
      reverse(one); //revrersing the first list
      reverse(two); //reversing the second list
      ...
      reverse(three);
      reverse(one); //getting back the same list
      reverse(two); //getting back the same list
